...
queueteleport =  missing("function", queue_on_teleport or queueonteleport or (syn and syn.queue_on_teleport) or (fluxus and fluxus.queue_on_teleport))
                ...
                -- ======== Auto Farm =======
                    ...
                    spawn(function()
                        while true and task.wait(0.5) do
                            local proximiStuck = game:GetService("Players").LocalPlayer.PlayerGui.ProximityPrompts:GetChildren()
